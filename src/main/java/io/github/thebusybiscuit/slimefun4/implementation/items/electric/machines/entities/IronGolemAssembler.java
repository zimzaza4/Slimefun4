...
public class IronGolemAssembler extends AbstractEntityAssembler<IronGolem> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(1, new CustomItem(getHead(), "&7在此处放入南瓜", "", "&f这里可以放入南瓜"), ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(7, new CustomItem(getBody(), "&7在此处放入铁块", "", "&f这里可以放入铁块"), ChestMenuUtils.getEmptyClickHandler());

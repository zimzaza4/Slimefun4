...
public final class ResearchSetup {
    ...
    public static void setupResearches() {
        ...
        register("gold_armor", 87, "Shiny Armor", 13, SlimefunItems.GOLD_HELMET_12K, SlimefunItems.GOLD_CHESTPLATE_12K, SlimefunItems.GOLD_LEGGINGS_12K, SlimefunItems.GOLD_BOOTS_12K);

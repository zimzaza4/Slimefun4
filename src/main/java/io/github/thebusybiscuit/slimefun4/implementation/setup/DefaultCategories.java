...
class DefaultCategories {
    ...
    protected final LockedCategory gps = new LockedCategory(new NamespacedKey(SlimefunPlugin.instance(), "teleporter"), new CustomItem(SlimefunItems.GPS_TRANSMITTER, "&bGPS-based Machines"), 4, basicMachines.getKey());

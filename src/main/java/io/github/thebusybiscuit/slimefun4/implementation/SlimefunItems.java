...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack QUICKLY_PORTABLE_TELEPORTER = new SlimefunItemStack("PORTABLE_TELEPORTER", Material.COMPASS, "&e加强&b便携式传送器", "", "&f可以&e更快地&f让你随时随地传送到", "&f要传送的传送点", "", LoreBuilder.powerCharged(0, 200), "", "&e右键&7 使用");
